...
INSERT INTO `product` (`name`, `category`, `weight`, `price_per_kg`) VALUES ('Chicken', 'Meats', 200.0, 5.99);
...
INSERT INTO `product` (`name`, `category`, `weight`, `price_per_kg`) VALUES ('Knock Bread', 'Grains', 120.0, 2.49);
INSERT INTO `product` (`name`, `category`, `weight`, `price_per_kg`) VALUES ('Oatmeal', 'Grains', 80.0, 1.99);
INSERT INTO `product` (`name`, `category`, `weight`, `price_per_kg`) VALUES ('Pasta', 'Grains', 150.0, 3.49);
